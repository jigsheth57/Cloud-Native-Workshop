...
. Visit the application in your browser by hitting the route that was generated by the CLI. For example: point the browser to following url: http://contactdataservice-untippled-birthplace.cfapps.io/contacts
