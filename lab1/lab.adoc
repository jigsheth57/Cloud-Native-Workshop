...
== Test the back-end data service app using Spring REST Shell

You can either install link:++https://github.com/spring-projects/rest-shell#readme++[Spring REST Shell] by clicking on the link to test out the application or you can download the link:++https://chrome.google.com/webstore/detail/advanced-rest-client/hgmloofddffdnphfgcellkdfbfbjeloo++[Advanced Rest Client Application] by clicking on the link and follow the next section to test out the application.
